...
import com.jiecheng.subject.application.convert.SubjectAnswerDTOConverter;
import com.jiecheng.subject.application.convert.SubjectInfoDTOConverter;
...
public class SubjectController {
    ...
    public Result<List<SubjectInfoDTO>> getContributeList() {
        try {
            ...
            log.info("SubjectCategoryController.getContributeList.dtoList:{}", dtoList);
